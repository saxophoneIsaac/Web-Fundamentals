...
// console.log() Pokemons with index greater than 99
...
for (var i = 0; i < pokémon.length; i++) {
    if (pokémon[i].id % 3 === 0) {
        console.log("ID is evenly divisible by 3:", pokémon[i])
    }
}
...
for (var i = 0; i < pokémon.length; i++) {
    if (pokémon[i].types.length > 1) {
        console.log("pokemons with more than one type:", pokémon[i])
    }
}
...
for (var i = 0; i < pokémon.length; i++) {
    if (pokémon[i].types.length == 2 && pokémon[i].types[1] == "flying") {
        console.log("Mystic bird:", pokémon[i].name, "-type:", pokémon[i].types[0])
    }
}
...
for (var i = 0; i < pokémon.length; i++) {
    ...
    // console.log(pokémon[i].types)
    if (pokémon[i].types.length == 1 && pokémon[i].types[0] == "poison") {
        var poisonIntoMedicine = "";
        for (var j = pokémon[i].name.length - 1; j >= 0; j--){
            poisonIntoMedicine += (pokémon[i].name[j]);
            // console.log("poison Pokemon:", pokémon[i].name)
        }
        poisonIntoMedicine = poisonIntoMedicine.toLowerCase();

    console.log("reverse the poison:", poisonIntoMedicine)
    }
}